 ...
 */
export let controllerColaborador = async (user, id_empresa) => {
 ...
 */
export let controllerGetColaborador = async (table, id) => {
 ...
 */
export let postVaga = async (vaga, id_empresa) => {
...
export let getVagaById = async (id) => {
    try {
        ...
        console.log(`✔️ Vagas encontradas: ${response.length || response.rows?.length || 0}`);
        return response;
    }
    catch (error) {
        console.log(error);
 ...
 */
export let postEvento = async (evento, id_calendario) => {
    try {
 ...
 */
export let deleteEvento = async (id) => {
    try {
 ...
 */
export let postCalendario = async (id) => {
 ...
 */
export let getCalendario = async (id) => {
    try {
