 ...
 */
export let createCalendario = async (id) => {
    ...
    newCalendar.setId();
    console.log(`🛠 [createCalendario] Inserindo calendário no banco de dados...`, {
    ...
    if (!result) {
        console.error(`❌ [createCalendario] Erro ao criar calendário no banco de dados.`, {
            calendarioId: newCalendar.id,
        });
 ...
 */
export let getCalendario = (monthNumber, year, events) => {
