...
export let getVagaById = async (id) => {
    try {
...
export let deleteVaga = async (id) => {
    try {
 ...
 */
export let createVaga = async (vaga, id_empresa) => {
    ...
    try {
        ...
        let newVaga = new Vaga(new Date(vaga.data_fim), vaga.titulo, vaga.descricao, vaga.salario, vaga.localidade, vaga.acessibilidade);
        ...
        await DB.insertVaga(newVaga.id, newVaga.data_inicio, newVaga.data_fim, newVaga.status, newVaga.titulo, newVaga.descricao, newVaga.salario, newVaga.localidade, newVaga.acessibilidade, id_empresa);
 ...
 */
export let registerCandidateToVaga = async (id_candidate, id_vaga) => {
