...
describe('Entities', () => {
    describe('Candidate', () => {
        it('deve criar candidato com dados corretos', async () => {
            const candidate = new Candidate('João Silva', 'joao@email.com', 'joao@email.com', '123456', '123456', '11999999999', '12345678901', new Date('1990-01-01'), false, true, false, false, false, '', true, 'Cadeirante');
    ...
    describe('Contratante', () => {
        it('deve criar contratante com dados corretos', async () => {
            const contratante = new Contratante('Tech Corp', 'Tech Corp LTDA', 'contato@tech.com', 'contato@tech.com', '123456', '123456', '12345678000195', '1133334444', 'Rampa de acesso');
    ...
    describe('Event', () => {
        it('deve criar evento com dados corretos', () => {
            const event = new Event('Reunião', 'Reunião de equipe', new Date('2024-01-15'), '09:00', '10:00', 'CAND-123456');
            event.setId();
    ...
    describe('Vaga', () => {
        it('deve criar vaga com dados corretos', () => {
            const vaga = new Vaga(new Date('2024-12-31'), 'Desenvolvedor', 'Vaga para desenvolvedor React', 5000, 'São Paulo', 'Rampa de acesso');
