 ...
 */
export let validateId = async (id, table) => {
 ...
 */
export let validateIdCandidato = async (id) => {
 ...
 */
export let validateIdByRelation = async (value, data, table) => {
